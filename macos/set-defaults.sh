...
if [ -n "$TRAVIS_JOB_ID" ]; then
    echo "  › Speed up wake from sleep (standby after 24 hours instead of an hour)"
...
echo "  › Set the Finder prefs for showing/hiding a few different volumes on the Desktop"
