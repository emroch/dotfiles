# Generated by Powerlevel10k configuration wizard on 2023-02-21 at 15:51 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 29251.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, slanted separators, round heads, round tails, 2 lines, dotted, no frame,
...
() {
  ...
  function p10k-on-post-prompt() {
    if [[ $last_prompt_dir == $PWD ]]; then
      # Hide the empty line and the first prompt line.
      p10k display 'empty_line|1'=hide '2/right'=show
    fi
    last_prompt_dir=$PWD
  }
